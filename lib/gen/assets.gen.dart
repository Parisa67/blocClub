...
class $AssetsImgStoriesGen {
  ...
  /// File path: assets/img/stories/onboarding.png
  AssetGenImage get onboarding =>
      const AssetGenImage('assets/img/stories/onboarding.png');

  /// File path: assets/img/stories/single_post.png
  AssetGenImage get singlePost =>
      const AssetGenImage('assets/img/stories/single_post.png');

  /// File path: assets/img/stories/splash.png
  AssetGenImage get splash =>
      const AssetGenImage('assets/img/stories/splash.png');
